import { StaticMongoModel, StaticRedisModel, StaticSqlModel, BaseModel } from 'src/models/base/base_model';
...
class RepoFactory {
    public static getSql<ModelClass extends BaseModel>(modelClass: StaticSqlModel<ModelClass>): SQLRepo<ModelClass> {
